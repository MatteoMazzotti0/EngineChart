...
constexpr auto qt_meta_stringdata_CLASSInfoWidgetENDCLASS = QtMocHelpers::stringData(
    "InfoWidget",
    "startSim",
    "",
    "inspectSensor",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSInfoWidgetENDCLASS_t qt_meta_stringdata_CLASSInfoWidgetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 8),  // "startSim"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 13),  // "inspectSensor"
        QT_MOC_LITERAL(35, 10)   // "editSensor"
    },
    "InfoWidget",
    "startSim",
    "",
...
void InfoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->inspectSensor(); break;
        case 2: _t->editSensor(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &InfoWidget::startSim; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (InfoWidget::*)();
            if (_t _q_method = &InfoWidget::inspectSensor; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (InfoWidget::*)();
            if (_t _q_method = &InfoWidget::editSensor; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void InfoWidget::startSim()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void InfoWidget::inspectSensor()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void InfoWidget::editSensor()
{
